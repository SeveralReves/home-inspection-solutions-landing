            ...
            <div className="flex-1 flex flex-col gap-5 p-8">
                ...
                <div className="flex gap-5">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button className="w-full bg-secondary hover:bg-primary transition duration-300 text-white p-3 rounded-lg font-semibold">
                            SUBMIT
                        </button>
                    </form>
                    ...
                    <div className="text-gray-700 hover:text-secondary flex flex-col gap-4">
                        <a href="mailto:hinspectionsolutions@gmail.com" target="_blank" rel="noopener noreferrer" className="flex gap-2">
                            ...
                            <span class="flex-1">hinspectionsolutions@gmail.com</span>
                        </a>
                        ...
                        <p className="flex gap-2">
                            ...
                            <span class="flex-1">
                            3894 Stratford Cir, Valdosta,
                            GA 31605, Estados Unidos
                            </span>
                        </p>
                    </div>
                </div>
