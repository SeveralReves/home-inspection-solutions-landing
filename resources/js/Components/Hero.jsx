        ...
        <section className={`${styles.hero} container flex items-center`}>
           ...
           <div className="max-w-md  bg-white rounded-3xl shadow-lg p-8 ">
            <h2 className="text-3xl font-bold text-primary">
                LOREM IPSUM <span className="text-secondary">IS</span>
            </h2>
            <h2 className="text-3xl font-bold text-primary mt-1">SIMPLY</h2>
            ...
            <div className="flex justify-center mt-6 space-x-4">
                <button className="bg-secondary text-white font-semibold py-2 px-6 rounded-full shadow-lg">
                    SERVICES
                </button>
